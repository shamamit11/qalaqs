    ...
    public function productDetail($id)
    {
        try {
            ...
            if ($product) {
                ...
                $product->make = isset($product->make_id) ? $product->make->name : "";
                $product->model = isset($product->model_id) ? $product->model->name : "";
                $product->year = isset($product->year_id) ? $product->year->name : "";
                $product->engine = isset($product->engine_id) ? $product->engine->name : "";
                $product->brand = isset($product->brand_id) ? $product->brand->name : "";
                $product->category_type = $product->category->type;
                $product->category = isset($product->category_id) ? $product->category->name : "";
                $product->subcategory = isset($product->subcategory_id) ? $product->subcategory->name : "";;
