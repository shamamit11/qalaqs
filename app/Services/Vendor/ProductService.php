...
class ProductService
{
    ...
    public function store($request) {
        try {
            ...
            $product->make_id = isset($request['make_id']) ? $request['make_id'] : 0;
            $product->model_id = isset($request['model_id']) ? $request['model_id'] : 0;
            $product->year_id = isset($request['year_id']) ? $request['year_id'] : 0;
            $product->engine_id = isset($request['engine_id']) ? $request['engine_id'] : 0;
