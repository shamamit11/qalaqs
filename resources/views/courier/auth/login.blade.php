                    ...
                    <div class="card mt-3">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                <h4 class="text-uppercase mt-0">Courier Sign In</h4>
                            </div>
                            ...
                            <form id="frm_login" method="post" action="{{ route('courier-checkLogin') }}">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Email</label>
                                    <input class="form-control" name="email" type="text" placeholder="Enter your email address" id='email'>
                        ...
                        <div class="row mb-3">
                            <div class="col-12 text-center">
                                <p> <a href="{{route('courier-forgot-password')}}" class="text-muted ms-1"><i
