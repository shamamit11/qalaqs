@php
    ...
    if($user->image) {
        $user_image = asset('/storage/courier/' . $user->image);
    } 
    else {
...
<div class="navbar-custom">
  <ul class="list-unstyled topnav-menu float-end mb-0">
      <li class="dropdown notification-list topbar-dropdown"> <a
          ...
          <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
              <!-- item-->
              <a href="{{ route('courier-account-setting') }}" class="dropdown-item notify-item"> <i
                      class="fe-settings"></i> <span>Account Settings</span> </a>
              <a href="{{ route('courier-account-change-password') }}" class="dropdown-item notify-item"> <i
                      class="fe-lock"></i> <span>Change Password</span> </a>
              <div class="dropdown-divider"></div>
              <a href="{{ route('courier-logout') }}" class="dropdown-item notify-item"> <i class="fe-log-out"></i>
                  <span>Logout</span> </a>
          </div>
      </li>
  </ul>
  ...
  <!-- LOGO -->
  <div class="logo-box">
      <a href="{{ route('courier-dashboard') }}" class="logo logo-light text-center">
          <span class="logo-sm">
      ...
      <a href="{{ route('courier-dashboard') }}" class="logo logo-dark text-center">
          <span class="logo-sm">
              <img src="{{ asset('assets/admin/images/qalaqs-icon.png') }}" alt="" height="35">
          </span>
          <span class="logo-lg">
