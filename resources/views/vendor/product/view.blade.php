                                            ...
                                            <table class="table table-striped mb-0 ">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($row->status == 1)
                                                                <span class="badge bg-success" style="padding:6px; font-size:12px;">{{ $row->status == 1 ? 'Active' : 'Inactive' }}</span>
                                                            @else
                                                                <span class="badge bg-danger" style="padding:6px; font-size:12px;">{{ $row->status == 1 ? 'Active' : 'Inactive' }}</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="badge bg-success" style="padding:6px; font-size:12px;">{{ $row->admin_approved == 1 ? 'Approved' : 'Pending' }}</span>
                                                        @else
                                                            <span class="badge bg-danger" style="padding:6px; font-size:12px;">{{ $row->admin_approved == 1 ? 'Approved' : 'Pending' }}</span>
                                                        @endif
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="width:270px; padding:10px; background-color: #fff; border-radius: 10px;">
                                                            ...
                                                            @else
                                                                <img src="{{ asset('/assets/admin/images/browser.png')}}" width="250">
                                                            @endif
                                                        </div>
                                                    </td>
                                                    <td>
