                    ...
                    <div class="card mt-3">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                <h4 class="text-uppercase mt-0">Vendor Sign In</h4>
                            </div>
                            ...
                            <form id="frm_login" method="post" action="{{ route('vendor-checkLogin') }}">
                                @csrf
                                <div class="mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 text-center">
                                <p> <a href="{{route('vendor-forgot-password')}}" class="text-muted ms-1"><i
