                                                        ...
                                                        <div>
                                                            @if($user && $user->image)
                                                                <div style="margin:5px 0 0 0;"> 
                                                                    <img src="{{ asset('/storage/vendor/'.$user->image)}}" id="displayImg" class="profile-image-preview">
                                                                </div>
                                                            @else
                                                                <div style="margin:5px 0 0 0;"> 
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div>
                                                            @if($user && $user->license_image)
                                                                <div style="margin:5px 0 0 0;"> 
                                                                    <img src="{{ asset('/storage/vendor/'.$user->license_image)}}" id="displayLicenseImg" class="file-image-preview">
                                                                </div>
                                                            @else
                                                                <div style="margin:5px 0 0 0;"> 
