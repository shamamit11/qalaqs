...
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="form" method="post" action="{{ route('vendor-account-addaction') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" value="{{ $user->vendor_code }}" type="text"
                                                        readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div style="margin:5px 0 0 0;"> 
                                                                <img src="{{ asset('/storage/vendor/'.$user->image)}}" id="displayImg" width="200" class="file-image-preview">
                                                            </div>
                                                            @else
                                                            <div style="margin:5px 0 0 0;"> 
                                                                <img src="{{ asset('/assets/admin/images/browser.png')}}" id="displayImg" width="200" class="file-image-preview">
                                                            </div>
                                                            @endif
                                                            <div style="margin:5px 0 0 0;"
                                                                ...
                                                                <button type="button" class="btn btn-xs btn-danger"
                                                                    Onclick="confirmDelete('image', '{{$user->image}}', 'displayImg', 'btn_image_delete')">Delete Image</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <br>
                                                        <input type="file" name="file_license_image" id="file_license_image" class="d-none" onchange="licenseImageBrowser(this)">
                                                        <label type="button" for="file_license_image" class="btn btn-secondary">Choose File</label>
                                                        <input name="license_image" type="hidden" id="license_image" />
                                                        <div>
                                                            @if($user && $user->license_image)
                                                            <div style="margin:5px 0 0 0;"> 
                                                                <img src="{{ asset('/storage/vendor/'.$user->license_image)}}" id="displayLicenseImg" width="200" class="file-image-preview">
                                                            </div>
                                                            @else
                                                            <div style="margin:5px 0 0 0;"> 
                                                                <img src="{{ asset('/assets/admin/images/browser.png')}}" id="displayLicenseImg" width="200" class="file-image-preview">
                                                            </div>
                                                            @endif
                                                            <div style="margin:5px 0 0 0;"
                                                                class="{{ ($user && $user->license_image) ? 'd-block' : 'd-none' }}"
                                                                id='btn_license_image_delete'>
                                                                <button type="button" class="btn btn-xs btn-danger"
                                                                    Onclick="confirmDelete('license_image', '{{$user->license_image}}', 'displayLicenseImg', 'btn_license_image_delete')">Delete Image</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    @section('footer-scripts')
        @include('vendor.account.js.index')
    @endsection
