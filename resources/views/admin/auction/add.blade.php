                                ...
                                <form enctype="multipart/form-data" method="post" action="{{ $action }}" id="form">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="date" id="date"
                                                value="{{ old('date', isset($row->date) ? $row->date : '') }}">
                                            <div class="error" id='error_date'></div>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label"> Time</label>
                                            <input type="text" class="form-control" name="time" id="time"
                                                value="{{ old('time', isset($row->time) ? $row->time : '') }}">
                                    ...
                                    <div class="mb-3 row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="location" id="location"
                                                value="{{ old('location', isset($row->location) ? $row->location : '') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="map" id="map"
                                            value="{{ old('map', isset($row->map) ? $row->map : '') }}">
                                        <div class="error" id='error_map'></div>
                                    </div>
