...
<div class="content-page">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <nav class="navbar navbar-light">
                                    ...
                                    <a href="{{route('admin-subcategory-add')}}" class="btn btn-primary my-2 my-sm-0 ms-1">
                                        Add</a>
                                </nav>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr id="tr{{ $subcategory->id }}">
                                            ...
                                            <td><label class="switch" style="margin: 0 auto">
                                                    <input class="switch-input switch-status" type="checkbox"
                                                        ...
                                                        data-status-value="{{ $subcategory->status }}" @if($subcategory->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <div class="float-end"> {{$subcategories->links('pagination::bootstrap-4')}} </div>
                                    </div>
                                </div>
                                @else
    ...
    @include('admin.subcategory.js.index')
    @endsection