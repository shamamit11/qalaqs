                                ...
                                @if ($categories->count() > 0)
                                    <table class="table">
                                        <thead class="table-light">
                                            <tr>
                                                <th width="50">#</th>
                                                <th>Name</th>
                                                <th style="text-align:center" width="100"> Orders</th>
                                                ...
                                                <tr id="tr{{ $category->id }}">
                                                    ...
                                                    <td><label class="switch" style="margin: 0 auto">
                                                            <input class="switch-input switch-status" type="checkbox"
                                                                data-id="{{ $category->id }}"
                                                                data-status-value="{{ $category->status }}"
                                                                @if ($category->status == 1) checked @endif /> <span
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <div class="float-end"> {{ $categories->links('pagination::bootstrap-4') }}
                                            </div>
                                        </div>
                                    </div>
                                @else
