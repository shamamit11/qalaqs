...
<body class="loading authentication-bg authentication-bg-pattern">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4">
                            ...
                            <form id="frm_forgot" method="post" action="{{ route('supplier-forget-password') }}">
                                @csrf
                                <div class="mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 text-center">
                                <p> <a href="{{route('supplier-login')}}" class="text-muted ms-1"> Back To Log In</a></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    @include('supplier.auth.js.forgot')
    </html>