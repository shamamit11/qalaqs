...
<body class="loading authentication-bg authentication-bg-pattern">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4">
                            ...
                            <form id="frm_login" method="post" action="{{ route('supplier-checkLogin') }}">
                                @csrf
                                <div class="mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 text-center">
                                <p> <a href="{{route('supplier-forgot-password')}}" class="text-muted ms-1"><i class="fa fa-lock me-1"></i>Forgot
                                        your password?</a></p>
                                <p class="text-muted">Don't have an account? <a href="{{route('supplier-register')}}"
    ...
    @include('supplier.auth.js.login')
    </html>
